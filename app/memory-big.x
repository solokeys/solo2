MEMORY
{
  ...
  /* FLASH : ORIGIN = 0x00000000, LENGTH = 400K */
  /* FLASH : ORIGIN = 0x00000000, LENGTH = 500K */
  FLASH : ORIGIN = 0x00000000, LENGTH = 550K

  /* FILESYSTEM: ORIGIN = 0x00064000, LENGTH = 230K */
  /* FILESYSTEM: ORIGIN = 0x0007d000, LENGTH = 130K */
  /* FILESYSTEM: ORIGIN = 0x0007d000, LENGTH = 130K */
  FILESYSTEM: ORIGIN = 0x00089800, LENGTH = 80K
