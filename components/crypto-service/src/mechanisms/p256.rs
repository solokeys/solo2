...
Agree<'a, 's, R, P, V> for super::P256
{
        ...
        -> Result<reply::Agree, Error>
    {
        ...
        resources.load_serialized_key(&path, KeyKind::P256, &mut seed)?;
        ...
        resources.load_serialized_key(&path, KeyKind::P256, &mut public_bytes)?;
        ...
        resources.store_serialized_key(&path, KeyKind::SharedSecret32, &shared_secret)?;
...
DeriveKey<'a, 's, R, P, V> for super::P256
{
        ...
        -> Result<reply::DeriveKey, Error>
    {
        ...
        resources.store_serialized_key(&public_path, KeyKind::P256, keypair.public.as_bytes())?;
        Ok(reply::DeriveKey {
...
GenerateKey<'a, 's, R, P, V> for super::P256
{
        ...
        -> Result<reply::GenerateKey, Error>
    {
        ...
        resources.store_serialized_key(&path, KeyKind::P256, &seed)?;
...
Verify<'a, 's, R, P, V> for super::P256
{
        ...
        -> Result<reply::Verify, Error>
    {
        ...
        resources.load_serialized_key(&path, KeyKind::P256, &mut serialized_key)?;
